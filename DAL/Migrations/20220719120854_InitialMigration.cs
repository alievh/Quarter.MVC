        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CallOut = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentPlans", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutImage", x => new { x.AboutsId, x.ImagesId });
                    table.ForeignKey(
                        name: "FK_AboutImage_Abouts_AboutsId",
                        column: x => x.AboutsId,
                        principalTable: "Abouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AboutImage_Images_ImagesId",
                        column: x => x.ImagesId,
            ...
            migrationBuilder.CreateTable(
                name: "ApartmentPlanImage",
                columns: table => new
                {
                    ApartmentPlansId = table.Column<int>(type: "int", nullable: false),
                    ImagesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentPlanImage", x => new { x.ApartmentPlansId, x.ImagesId });
                    table.ForeignKey(
                        name: "FK_ApartmentPlanImage_ApartmentPlans_ApartmentPlansId",
                        column: x => x.ApartmentPlansId,
                        principalTable: "ApartmentPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApartmentPlanImage_Images_ImagesId",
                        column: x => x.ImagesId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageService", x => new { x.ImagesId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_ImageService_Images_ImagesId",
                        column: x => x.ImagesId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImageService_Services_ServicesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageSlider", x => new { x.ImagesId, x.SlidersId });
                    table.ForeignKey(
                        name: "FK_ImageSlider_Images_ImagesId",
                        column: x => x.ImagesId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImageSlider_Sliders_SlidersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutVideo", x => new { x.AboutsId, x.VideosId });
                    table.ForeignKey(
                        name: "FK_AboutVideo_Abouts_AboutsId",
                        column: x => x.AboutsId,
                        principalTable: "Abouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AboutVideo_Videos_VideosId",
                        column: x => x.VideosId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogImage", x => new { x.BlogsId, x.ImagesId });
                    table.ForeignKey(
                        name: "FK_BlogImage_Blogs_BlogsId",
                        column: x => x.BlogsId,
                        principalTable: "Blogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogImage_Images_ImagesId",
                        column: x => x.ImagesId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AboutImage_ImagesId",
                table: "AboutImage",
                column: "ImagesId");

            migrationBuilder.CreateIndex(
                name: "IX_AboutVideo_VideosId",
                table: "AboutVideo",
                column: "VideosId");

            migrationBuilder.CreateIndex(
                name: "IX_ApartmentPlanImage_ImagesId",
                table: "ApartmentPlanImage",
                column: "ImagesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageService_ServicesId",
                table: "ImageService",
                column: "ServicesId");

            migrationBuilder.CreateIndex(
                name: "IX_ImageSlider_SlidersId",
                table: "ImageSlider",
                column: "SlidersId");
